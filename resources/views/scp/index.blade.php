...
<div class="row mb-3">
    <div class="col-sm-9">
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('scp.index') }}">Sub County Pharmacist</a></li>
            ...
            <nav class="m-2">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile"
                        type="button" role="tab" aria-controls="nav-profile" aria-selected="false">PROCESSED</button>
                                    ...
                                    @foreach ($topups as $topup)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ( $topup->facility_id == $facility->id )
                                                {{ $facility->name }}
                                                @endif
                                                @endforeach
                                            </td>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="d-flex">
                                                        ...
                                                        <div style="padding-right:5px;">
                                                            <a href="{{ url('scp/' .$topup->id ) }}"
                                                                class="btn btn-sm btn-warning mr-3">
                                                                View Details
                                                            </a>
                                                        </div>
                                                        <form action="{{ url('scp/'.$topup->id) }}" method="post">
                                                            @csrf
                                                            @method('DELETE')
