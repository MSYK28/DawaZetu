                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" value="{{ $storetopup->requested_by }}"
                                    disabled placeholder="Enter Name" id="requested_by" name="requested_by">
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input required type="text" class="form-control" name="request_id"
                                    value="{{ $storetopup->request_id }}" disabled placeholder="Request ID">
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-3">
                            <div class="mb-3">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input required type="date" class="form-control" value="{{ $storetopup->request_date }}"
                                    name="request_date" disabled placeholder="Enter Date">
                            </div>
                        </div><!-- Col -->
                    </div><!-- Row -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input hidden type="text" name="allocated_units[]"
