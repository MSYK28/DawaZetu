<nav class="sidebar ">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['apps/topup']) }}">
        <a href="{{ url('topup') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Top Up Request</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/storetopup']) }}">
        <a href="{{ url('storetopup') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Store Top Up</span>
        </a>
      </li>
      <li class="nav-item {{ active_class(['apps/scp']) }}">
        <a href="{{ url('scp') }}" class="nav-link">
          <i class="link-icon" data-feather="calendar"></i>
          <span class="link-title">Sub County Pharmacist</span>
        </a>
      </li>
